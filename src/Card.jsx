    ...
    <div className="flex">
      ...
      <div className="simple-linear">
        <div className="h-screen flex-1 p-7">
          <h1 className="text-2xl font-semibold ">Control Hotel</h1>
          <br></br>
          <p className="texto1">
          ...
          <div className="container">
            <div className="row">
              ...
              <body>
                <div className="container">
                  <div class="card">
                    <img src="https://www.hotelessoleilguatemala.com/soleil_antigua/templates/yootheme/cache/d7/Panorama_las-villas-d763012c.jpeg" class="card-img-top" alt="..."></img>
                    <div class="card-body">
                      <p class="card-text-5">
                        Estos hoteles fueron ampleamente inspeccionados por criticos expertos, para poder lograrle dar una experiencia
                        unica e irrepetible.
                        <br>
                        </br>
                        <br>
                        </br>
                        Gracias a nuestro amplio menu de hoteles usted podra elegir el de su preferencia. Logrando de esto que gracias
                        a todos los hoteles los cuales tenemos organizados por el país podra conocer muchos departamentos y lugares
                        del país de Guatemala que no se imaginaria que existiria.
                        <br>
                        </br>
                        <br>
                        </br>
                        Deje en nuestras manos el lograr darle una experiencia que no olvidara y poder lograr un excelente descanso para usted
                        y su familia.</p>
                    </div>
                  </div>
                </div>
          ...
          <footer className="footer">
            <p class="text-center">Derechos Reservados @ControlHoteles.gmail.com</p>
          </footer>
